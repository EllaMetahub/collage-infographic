...
不要改写、不要翻译、不要压缩。完整文件：[`skills/collage-infographic/references/style-prompt.md`](skills/collage-infographic/references/style-prompt.md)

```text
拼贴感信息图插画（Collage Infographic Illustration），同时混合了一点 复古纸媒 + 扁平矢量 + 轻波普元素 的方向。可以理解为一种 “编辑式插画风”，常见在专题封面、博客头图、知识型内容配图里。
核心特征
...
1. Paste the locked style prompt **verbatim**
2. Explain **one** viewpoint visually
3. Build cut-out paper layers (not a 3D scene)
4. Keep grainy print texture + flat color blocks
5. Use cobalt / violet / tangerine / beige unless you name another palette
